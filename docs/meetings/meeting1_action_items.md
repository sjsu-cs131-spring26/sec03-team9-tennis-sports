...
- Action item: Sprint Board & Ticketing
  Owner: Md Waez Islam
  Due: 3/11
  Definition of Done: Sprint board filled out with sprint 3 tickets & all tasks completed.

- Action item: Document Meeting Artifacts
  Owner: Shakshi Sharma
  Due: 3/11
...
- Action item: Decision Brief
  Owner: Md Waez Islam
  Due: 3/11
  Definition of Done: Finalized decision brief document & reviewed with the whole team.
