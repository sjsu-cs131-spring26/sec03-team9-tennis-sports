...
from pyspark.sql.functions import col, hour, to_date, count, avg, broadcast, round, stddev, concat_ws, desc
...
def main():
    ...
    summary = (recent_winners
        ...
        .orderBy(col("winner_avg_bp_saved").desc()))
